...
class admin_model extends Model
{
    ...
    public function getAdminPageSensorData()
    {
        return Database::select("
            SELECT snl.node_id, sd.type, st.unit, ROUND(AVG(value), 2) as value, DATE(measure_time) AS date, HOUR(measure_time) AS hour, FLOOR(MINUTE(measure_time) / 6) AS minute_window_id
            ...
            GROUP BY date, hour, minute_window_id
